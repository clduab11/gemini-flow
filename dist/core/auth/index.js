...
export class AuthSystemFactory {
     ...
     */
    static async createAuthSystem(config) {
     ...
     */
    static createVertexAISystem(config) {
...
export class AuthHelpers {
     ...
     */
    static createGoogleOAuth2Config(clientId, clientSecret, redirectUri) {
        return {
            clientId,
            clientSecret,
     ...
     */
    static createVertexAIConfig(projectId, location, options = {}) {
        return {
            projectId,
            location,
    ...
    static validateConfig(config) {
        ...
        if (config.providers.vertexAI) {
            ...
            if (!vertexAI.projectId)
                errors.push("Vertex AI projectId is required");
            if (!vertexAI.location)
