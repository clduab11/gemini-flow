...
export var SparcWorkflow;
(function (SparcWorkflow) {
    SparcWorkflow["Sequential"] = "sequential";
    SparcWorkflow["Parallel"] = "parallel";
    SparcWorkflow["Iterative"] = "iterative";
    SparcWorkflow["Pipeline"] = "pipeline";
    SparcWorkflow["Collaborative"] = "collaborative";
    SparcWorkflow["Specialized"] = "specialized";
