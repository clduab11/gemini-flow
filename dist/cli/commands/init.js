...
export class InitCommand extends Command {
    ...
    constructor(configManager) {
        ...
        this.description("Initialize Gemini-Flow in the current directory")
    ...
    async checkExistingProject(directory) {
        try {
        ...
        const answers = await inquirer.prompt([
            ...
            },
            {
                ...
                choices: [
                    ...
                    {
                        name: "Full-Stack - Complete application template",
                        value: "fullstack",
                    },
    ...
    async createProjectStructure(directory, config) {
        const directories = [
            ".gemini-flow",
            ".gemini-flow/agents",
            ".gemini-flow/swarms",
    ...
    async createConfigFiles(directory, config) {
        ...
        await writeFile(join(directory, ".gemini-flow", "config.json"), JSON.stringify(projectConfig, null, 2));
...
`;
    ...
    async createBasicTemplate(directory) {
        const indexJs = `/**
...
`;
    ...
    async createFullStackTemplate(directory) {
        // API entry point
        const apiIndex = `/**
...
<body>
    ...
    async createResearchTemplate(directory) {
