...
import { A2AMultimediaProtocol } from './a2a-multimedia-protocol';
...
export class A2AMultimediaGoogleIntegration {
     ...
     */
    async processMultimediaRequest(request) {
        try {
     ...
     */
    async synchronizeMultimediaContent(sessionId, contentId, participants) {
        try {
            if (!this.a2aProtocol) {
            ...
            const syncResponse = await this.a2aProtocol.synchronizeContent(session.a2aSessionId, {
                contentId,
...
//# sourceMappingURL=a2a-multimedia-integration.js.map