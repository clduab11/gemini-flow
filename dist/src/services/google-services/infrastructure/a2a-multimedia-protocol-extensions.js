...
export class RoutingEngine extends EventEmitter {
    ...
    async findOptimalRoute(sourceId, targetId, qos) {
        try {
            // Check cache first
    ...
    async calculateOptimalRoute(sourceId, targetId, qos) {
        ...
        const scoredPaths = await Promise.all(availablePaths.map(async (path) => {
...
//# sourceMappingURL=a2a-multimedia-protocol-extensions.js.map