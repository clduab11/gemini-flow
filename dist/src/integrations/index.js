...
export class IntegrationFactory {
    static createMarinerIntegration(config) {
        return {
    ...
    static createVeo3Integration(config) {
        return {
    ...
    static createSparcConnector(config) {
...
(function (IntegrationStatus) {
    ...
    IntegrationStatus["BUSY"] = "busy";
    IntegrationStatus["ERROR"] = "error";
    IntegrationStatus["SHUTDOWN"] = "shutdown";
