...
export function registerHiveCommands(program) {
    ...
    hiveCommand
        ...
        try {
            ...
            console.log(`  ID: ${queenAgent.config.id}`);
            console.log(`  Name: ${queenAgent.config.name}`);
            console.log(chalk.blue('\nWorker Swarm Status:'));
    ...
    hiveCommand
        ...
        try {
            ...
            const dashboardUrl = `https://hive-mind-dashboard.appspot.com/${queenAgent.config.id}`;
