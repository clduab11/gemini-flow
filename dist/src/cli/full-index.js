...
import { InitCommand, SwarmCommand, AgentCommand, TaskCommand, SparcCommand, HiveMindCommand, MemoryCommand, HooksCommand, SecurityFlagsCommand, ConfigCommand, WorkspaceCommand, GeminiCommand, registerMcpCommands, } from "./commands/index.js";
...
function setupProgram() {
    program
        .name("gemini-flow")
        .description("Revolutionary AI orchestration platform with advanced agent coordination")
        .version(version)
...
function setupCommands() {
    ...
    program
        ...
        .action(() => {
        console.log(chalk.yellow("Use: gemini-flow hive-mind consensus <proposal>"));
        console.log(chalk.gray('Example: gemini-flow hive-mind consensus "Deploy new feature X"'));
    });
    program
        .command("monitor")
        ...
        console.log(chalk.gray("Example: gemini-flow swarm monitor --protocols --performance"));
    });
    program
        .command("quantum")
        ...
        console.log(chalk.gray("Example: gemini-flow gemini quantum portfolio --demo"));
    });
    ...
    program
        ...
        try {
            ...
            if (!allPassed) {
                ...
                console.log(chalk.gray("Set GEMINI_API_KEY environment variable for full functionality."));
            }
            else {
    ...
    program
        ...
        console.log(chalk.cyan("Features:"), "A2A Protocol, MCP Integration, Quantum Processing");
    });
}
/**
 * Handle errors
...
function showWelcomeMessage() {
    console.log(banner);
    console.log(chalk.yellow("🚀 Welcome to Gemini-Flow AI Orchestration Platform!\n"));
    console.log(chalk.cyan("Quick Start Commands:"));
    console.log(chalk.gray("  gemini-flow init                    "), chalk.white("Initialize new project"));
    console.log(chalk.gray("  gemini-flow hive-mind spawn <task> "), chalk.white("Spawn coordinated agents"));
    console.log(chalk.gray("  gemini-flow agents spawn --count 5 "), chalk.white("Create agent swarm"));
    console.log(chalk.gray("  gemini-flow doctor                  "), chalk.white("Check system health"));
    console.log(chalk.cyan("\nAdvanced Features:"));
    console.log(chalk.gray("  gemini-flow sparc orchestrate      "), chalk.white("SPARC methodology"));
    console.log(chalk.gray("  gemini-flow swarm init --topology  "), chalk.white("Swarm coordination"));
    console.log(chalk.gray("  gemini-flow gemini quantum          "), chalk.white("Quantum processing"));
    console.log(chalk.cyan("\nGet Help:"));
    console.log(chalk.gray("  gemini-flow --help                  "), chalk.white("Show all commands"));
    console.log(chalk.gray("  gemini-flow <command> --help        "), chalk.white("Command-specific help"));
...
// Export for testing
export { program };
//# sourceMappingURL=full-index.js.map