...
export type LearningEventType = "pattern_learned" | "style_extracted" | "code_generated" | "template_created" | "session_started" | "session_completed" | "error_occurred";
...
export type PatternType = "function" | "class" | "interface" | "component" | "hook" | "module" | "import" | "export" | "async-pattern" | "error-handling" | "testing-pattern" | "architecture" | "crud" | "repository" | "service" | "controller" | "middleware" | "route";
export type GenerationApproach = "template" | "pattern" | "ai" | "hybrid";
export type FileType = "source" | "test" | "config" | "documentation";
export type FrameworkType = "react" | "vue" | "angular" | "svelte" | "node" | "express" | "fastify" | "nestjs" | "next" | "nuxt" | "typescript" | "javascript";
export type LanguageType = "typescript" | "javascript" | "python" | "go" | "rust" | "java" | "c#" | "php" | "ruby";
export type NamingConvention = "camelCase" | "snake_case" | "PascalCase" | "kebab-case" | "UPPER_CASE";
