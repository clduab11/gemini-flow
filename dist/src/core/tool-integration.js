...
export class ToolIntegration {
     ...
     */
    async persistToolState(toolName, stateKey, state) {
     ...
     */
    async retrieveToolState(toolName, stateKey) {
     ...
     * @returns {Promise<any>}
     */
    async enhanceToolWithAI(toolName, aiServiceMethod, args) {
     ...
     */
    async optimizeMcpCommunication(toolName, data) {
     ...
     */
    async coordinateMultiToolWorkflow(workflowSteps, agentId) {
     ...
     * @returns {Promise<void>}
     */
    async setupRealtimeMonitoringAndAlerting() {
...
//# sourceMappingURL=tool-integration.js.map