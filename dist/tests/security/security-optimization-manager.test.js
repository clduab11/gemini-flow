...
describe('SecurityOptimizationManager', () => {
    ...
    beforeEach(async () => {
        ...
        securityManager = new SecurityOptimizationManager(mockOrchestrator, mockPerformance, mockAuth, mockRouter);
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    ...
    describe('--auto-route Flag', () => {
        test('should enable auto-route with default configuration', async () => {
            ...
            expect(mockRouter.addRule).toHaveBeenCalledWith(expect.objectContaining({
        ...
        test('should validate access permissions for auto-route', async () => {
            ...
            await expect(securityManager.enableAutoRoute()).rejects.toThrow('Insufficient role permissions');
        });
    ...
    describe('--cost-optimize Flag', () => {
        ...
        test('should enforce budget limits', async () => {
            ...
            expect(mockOrchestrator.on).toHaveBeenCalledWith('request_completed', expect.any(Function));
        });
    ...
    describe('--canary-deploy Flag', () => {
        ...
        test('should validate deployment permissions', async () => {
            ...
            await expect(securityManager.enableCanaryDeployment(deploymentOptions)).rejects.toThrow('Insufficient role permissions');
        });
    ...
    describe('--slack-updates Flag', () => {
        ...
        test('should validate webhook URL security', async () => {
            ...
            await expect(securityManager.enableSlackUpdates(insecureConfig)).rejects.toThrow('Webhook URL must use HTTPS');
        });
    ...
    describe('--analyze-self Flag', () => {
        ...
        test('should validate analysis permissions', async () => {
            ...
            await expect(securityManager.enableSelfAnalysis()).rejects.toThrow('Insufficient role permissions');
        });
    ...
    describe('--meta-optimization Flag', () => {
        ...
        test('should validate meta-optimization permissions', async () => {
            ...
            await expect(securityManager.enableMetaOptimization()).rejects.toThrow('Insufficient role permissions');
        });
    ...
    describe('Security and Access Control', () => {
        test('should enforce role-based access control', async () => {
            ...
            await expect(securityManager.enableAutoRoute()).rejects.toThrow('Insufficient role permissions');
            await expect(securityManager.enableCostOptimization()).rejects.toThrow('Insufficient role permissions');
        });
        ...
        test('should validate emergency overrides when disabled', async () => {
            ...
            await expect(securityManager.enableAutoRoute({ securityOverride: true })).rejects.toThrow('Emergency overrides disabled');
        });
    ...
    describe('Error Handling and Resilience', () => {
        ...
        test('should validate configuration parameters', async () => {
            await expect(securityManager.enableCostOptimization({
...
//# sourceMappingURL=security-optimization-manager.test.js.map