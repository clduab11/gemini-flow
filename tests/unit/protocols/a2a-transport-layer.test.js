...
class A2ATransportLayer {
    ...
    async shutdown() { }
    async connect(agentId, config) { return {}; }
    async disconnect(connectionId) { }
    async sendMessage(connectionId, message) { return {}; }
    async sendNotification(connectionId, notification) { }
    async broadcastMessage(message, excludeConnections) { return []; }
    getActiveConnections() { return new Map(); }
    getConnectionByAgentId(agentId) { return undefined; }
    getTransportMetrics() { return {}; }
    isProtocolSupported(protocol) { return true; }
}
