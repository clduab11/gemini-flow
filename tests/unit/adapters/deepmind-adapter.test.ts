...
import type { DeepMindAdapterConfig, ModelRequest } from '../../../src/adapters/deepmind-adapter';
...
describe('DeepMindAdapter', () => {
  let adapter: DeepMindAdapter;
  const config: DeepMindAdapterConfig = {
  ...
  describe('initialization', () => {
    ...
    it('should initialize enterprise features when configured', async () => {
      const enterpriseConfig: DeepMindAdapterConfig = {
        ...config,
        enterpriseFeatures: {
          dataResidency: 'us',
          auditLogging: true,
  ...
  describe('error handling', () => {
    ...
    it('should handle enterprise access control', async () => {
      const restrictedConfig: DeepMindAdapterConfig = {
        ...config,
        enterpriseFeatures: {
          accessControls: ['pro', 'enterprise']
        }
