...
describe('GoogleAIAuth', () => {
    ...
    describe('saveConfig()', () => {
        ...
        it('should save config to file', async () => {
            ...
            expect(mockFs.writeFileSync).toHaveBeenCalledWith(configPath, expect.stringContaining('AIzaSyDummy1234567890abcdefghijklmnop'));
        });
...
//# sourceMappingURL=google-ai-auth.test.js.map