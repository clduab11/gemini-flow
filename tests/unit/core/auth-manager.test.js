...
describe('AuthManager', () => {
    ...
    describe('tier detection', () => {
        ...
        it('should detect enterprise tier with workspace domain', async () => {
            ...
            authManager.detectWorkspaceDomain = jest.fn().mockResolvedValue('company.com');
            await authManager.initialize();
            const tier = authManager.getDetectedTier();
    ...
    describe('token management', () => {
        ...
        it('should cache access tokens', async () => {
            ...
            const mockAuth = authManager.googleAuth;
    ...
    describe('project management', () => {
        ...
        it('should handle validation errors gracefully', async () => {
            ...
            mockAuth.getProjectId.mockRejectedValue(new Error('Invalid credentials'));
            authManager.googleAuth = mockAuth;
            const isValid = await authManager.validateCredentials();
    ...
    describe('error handling', () => {
        it('should handle missing credentials gracefully', async () => {
            ...
            // Mock ADC failure
            const mockAuth = new GoogleAuth();
            mockAuth.getClient.mockRejectedValue(new Error('Could not load the default credentials'));
            authManager.googleAuth = mockAuth;
