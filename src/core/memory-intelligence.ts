...
export class MemoryIntelligence {
   ...
   */
  public async semanticSearch(query: string, tables: string[], limit: number = 10): Promise<any[]> {
   ...
   */
  public async getContextAwareMemories(agentId: string, sessionId: string, currentQuery: string, limit: number = 5): Promise<any[]> {
   ...
   * @returns {Promise<void>}
   */
  public async manageMemoryLifecycle(memoryId: string, action: 'archive' | 'delete' | 'update', updates?: Partial<Memory>): Promise<void> {
   ...
   */
  public async analyzeRelationships(): Promise<any> {
   ...
   * @returns {Promise<void>}
   */
  public async prioritizeMemories(memoryIds: string[]): Promise<void> {
