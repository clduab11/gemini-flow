...
export class SQLiteConnectionPool extends EventEmitter {
  ...
  async initialize(): Promise<void> {
    try {
      ...
      this.implementation = this.config.preferredImplementation || detection.recommended;
   ...
   */
  private findConnectionByDatabase(database: SQLiteDatabase): PooledConnection | null {
    for (const connection of this.connections.values()) {
