...
export class IntelligentFormFiller extends BaseIntegration {
  ...
  private mapFormData(formData: Record<string, any>, formStructure: FormStructure): Map<string, any> {
  ...
  private smartMatchField(field: FormField, formData: Record<string, any>): any {
  ...
  private generateSmartDefault(field: FormField): any {
    for (const smartDefault of this.smartDefaults) {
      const fieldText = (field.name + ' ' + field.placeholder + ' ' + field.type).toLowerCase();
  ...
  private async fillFieldByType(page: any, selector: string, value: any, fieldInfo: any): Promise<void> {
  ...
  private async fillInputField(page: any, selector: string, value: any, type: string): Promise<void> {
    switch (type) {
      case 'checkbox':
      case 'radio':
        if (value) {
  ...
  private async fillSelectField(page: any, selector: string, value: any): Promise<void> {
  ...
  private async fillTextareaField(page: any, selector: string, value: any): Promise<void> {
    await page.click(selector);
  ...
  private async fillGenericField(page: any, selector: string, value: any): Promise<void> {
  ...
  private async tryAlternativeFilling(page: any, selector: string, value: any): Promise<boolean> {
  ...
  private async submitForm(tab: BrowserTab, formStructure: FormStructure): Promise<SubmissionResult> {
    const page = tab.page;
    
    try {
      this.logger.info('Submitting form', { formSelector: formStructure.selector });
