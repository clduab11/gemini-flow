...
export class HooksCommand extends Command {
  ...
  private async preTask(options: any): Promise<void> {
    ...
    if (options.autoSpawnAgents) {
      console.log(
        chalk.gray("  ✅ Auto-spawning agents based on task complexity"),
      );
    }
    ...
    console.log(
      chalk.gray("  📝 Task:"),
      options.description || "General task",
    );
    console.log(chalk.gray("  🔄 Session:"), "swarm-" + Date.now());
  }

  private async postEdit(options: any): Promise<void> {
  ...
  private async postTask(options: any): Promise<void> {
  ...
  private async sessionEnd(options: any): Promise<void> {
  ...
  private async preSearch(options: any): Promise<void> {
