...
export const SPARC_MODES: Record<string, SparcMode> = {
  ...
  'tdd': {
    ...
    phases: ['test-design', 'test-implementation', 'code-implementation', 'refactoring'],
  ...
  'integration': {
    ...
    phases: ['component-analysis', 'integration-planning', 'implementation', 'testing'],
  ...
  'performance': {
    ...
    phases: ['profiling', 'bottleneck-analysis', 'optimization', 'benchmarking'],
  ...
  'ml': {
    ...
    agents: ['data-analyst', 'neural-architect', 'training-coordinator', 'model-deployer'],
    workflow: 'pipeline',
    temperature: 0.5
  },
  ...
  'quantum': {
    ...
    phases: ['algorithm-design', 'circuit-creation', 'simulation', 'optimization'],
    agents: ['quantum-algorithm-specialist', 'quantum-circuit-designer', 'qubit-state-manager'],
  ...
  'consensus': {
    ...
    phases: ['protocol-selection', 'implementation', 'fault-tolerance', 'testing'],
    agents: ['byzantine-fault-tolerant', 'raft-consensus', 'crdt-manager', 'tester'],
    workflow: 'parallel',
    temperature: 0.3
  }
};
...
export const SPARC_PHASES: Record<string, SparcPhase> = {
  'specification': {
    ...
    successCriteria: ['Clear requirements', 'Measurable criteria', 'Stakeholder approval']
  },
  ...
  'pseudocode': {
    ...
    successCriteria: ['Complete logic coverage', 'Optimal algorithms', 'Clear structure']
  },
  ...
  'architecture': {
    ...
    successCriteria: ['Scalable design', 'Clear boundaries', 'Technology decisions']
  },
  ...
  'refinement': {
    ...
    successCriteria: ['Improved metrics', 'Maintained functionality', 'Clean code']
  }
};
